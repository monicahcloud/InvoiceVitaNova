    ...
    <section className="relative flex flex-col items-center justify-center py-12 lg:py-20">
      <div className="text-center">
        <span className="text-sm text-primary font-medium tracking-tight bg-primary/10 px-4 py-2 rounded-full">
          Introducing VitaNova 1.0
        </span>
        <h1 className="mt-8 text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-semibold tracking-tighter">
          Welcome to VitaNova Designs
          <span className="block lg:text-6xl mt-4 bg-gradient-to-l from-violet-500 via-violet-500 to-purple-500 text-transparent bg-clip-text">
